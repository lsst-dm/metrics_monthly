...
export RUN_ID="DM-36763"
export RUN_ID_URL="https://jira.lsstcorp.org/browse/DM-36763"
export VERSION_TAG="w_2022_44"

export SQUASH_USER=
export SQUASH_password=

export JSON_FOLDER=/fs/ddn/sdf/group/rubin/sandbox/hchiang2/metrics_json/w_2022_44/
